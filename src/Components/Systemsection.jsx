    ...
    <section id="system" className="section-paint-lazy relative bg-white py-16 sm:py-20 lg:py-32 overflow-hidden">
      ...
      <div className="absolute top-0 left-0 w-[250px] sm:w-[350px] md:w-[450px] lg:w-[500px] z-0 pointer-events-none">
        <svg viewBox="0 0 400 400" fill="none" xmlns="http://www.w3.org/2000/svg" className="w-full h-auto">
          ...
          <motion.g animate={{ y: [0, 8, 0], x: [0, 4, 0] }} transition={{ duration: 10, repeat: Infinity, ease: "easeInOut" }}>
            <path d="M0 240 C40 140 80 220 140 200 C220 170 190 70 270 60" stroke="#0C4DD5" strokeOpacity="0.3" strokeWidth="1.5" fill="none" />
            <path d="M0 255 C50 150 90 230 150 210 C230 180 200 80 280 70" stroke="#0C4DD5" strokeOpacity="0.2" strokeWidth="1.5" fill="none" />
            <path d="M0 270 C60 160 100 240 160 220 C240 190 210 90 290 80" stroke="#0C4DD5" strokeOpacity="0.1" strokeWidth="1.5" fill="none" />
            <path d="M0 285 C70 170 110 250 170 230 C250 200 220 100 300 90" stroke="#0C4DD5" strokeOpacity="0.05" strokeWidth="1.5" fill="none" />
          </motion.g>
        </svg>
      </div>
      ...
      <div className="absolute bottom-0 right-0 w-[250px] sm:w-[350px] md:w-[450px] lg:w-[500px] z-0 pointer-events-none">
        <svg viewBox="0 0 400 400" fill="none" xmlns="http://www.w3.org/2000/svg" className="w-full h-auto">
          ...
          {/* Floating Decorative Lines */}
          <motion.g animate={{ y: [0, -8, 0], x: [0, -4, 0] }} transition={{ duration: 10, repeat: Infinity, ease: "easeInOut" }}>
            <path d="M130 400 C150 320 230 350 260 270 C290 190 350 210 400 160" stroke="#0C4DD5" strokeOpacity="0.3" strokeWidth="1.5" fill="none" />
            <path d="M115 400 C135 310 215 340 245 260 C275 180 335 200 400 145" stroke="#0C4DD5" strokeOpacity="0.2" strokeWidth="1.5" fill="none" />
            <path d="M100 400 C120 300 200 330 230 250 C260 170 320 190 400 130" stroke="#0C4DD5" strokeOpacity="0.1" strokeWidth="1.5" fill="none" />
            <path d="M85 400 C105 290 185 320 215 240 C245 160 305 180 400 115" stroke="#0C4DD5" strokeOpacity="0.05" strokeWidth="1.5" fill="none" />
          </motion.g>
        </svg>
      </div>
